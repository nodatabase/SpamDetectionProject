...
MODEL_TYPE = 'HYBRID'
OUTPUT_FILE = f'accuracy_matrix_{MODEL_TYPE.lower()}.xlsx'
...
def main():
    ...
    try:
        ...
        pivot_df = df.pivot_table(index='training_set', columns='test_set', values='accuracy')

        pivot_df.to_excel(OUTPUT_FILE, sheet_name='Accuracy Matrix')
